...
This file is a template for agents that load Markdown instructions from this path. Adjust per your organization.
...
Skills are backed by the library under `skills/` in this repository. See the root README for research context and methodology.
